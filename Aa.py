...
def main_apv():
    ...
    r1=requests.get("https://github.com/DEVIL-NAJMUL/Aa/blob/main/Sm.txt").text
    ...
    if key1 in r1:
        ...
        print ("         ༄𝑟𝑖𝑎𝑧᭄•───────────────────────────────────────•༄𝑘ℎ𝑎𝑛᭄")
        print ("             \033[1;94mGIVE ME 100RS FOR APROVAL DEVIL")     
...
logo="""
        ...
        \033[1;92m༄𝑟𝑖𝑎𝑧᭄•───────────────────────────────────────•༄𝑘ℎ𝑎𝑛᭄
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
             \033[1;93m▇▇➣    \033[1;95mAUTHOR   : DEVILKHAN           \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;94mGITHUB   : DEVILKHAN           \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;93mFACEBOOK : DEVILKHAN           \033[1;93m▇▇
...
def dupcutter():
	...
	os.system("xdg-open https:// /+923188049915")
...
def yt():
	...
	os.system("xdg-open https://www.facebook.com/R.k.DEVILkhan.termux.tool.owner")
